class User < ApplicationRecord
  ...
  # instance method applies to an instance of a User e.g. current_user
  # Returns true if the instance of a User has the workout as a favourite
  # the self in self.workouts is implicit
