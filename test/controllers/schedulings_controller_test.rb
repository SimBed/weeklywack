...
class SchedulingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should display index when not logged in' do
  ...
  test 'should redirect create when not logged in' do
    ...
    post schedulings_path,
         params: { scheduling: { name: 'skiing', start_time: @scheduling.start_time, user_id: @user.id } }
    # end
  ...
  test 'should redirect show to other users scheduling' do
